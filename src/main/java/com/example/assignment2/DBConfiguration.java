...
public class DBConfiguration {
    ...
    protected static final String DB_BOOKS = "titles";
    ...
    protected static final String DB_BOOKS_AUTHORS = "authors";
    ...
    protected static final String DB_BOOKS_AUTHORS_BOOKS_BRIDGE = "authorisbn";
    ...
    public static Connection getBookDBConnection() throws SQLException{
